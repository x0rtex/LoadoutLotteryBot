...
@option(name="peacekeeper", description="Enter Peacekeeper's trader level", type=int, choices=[0, 1, 2, 3, 4])
@option(name="mechanic", description="Enter Mechanic's trader level", type=int, choices=[0, 1, 2, 3, 4])
@option(name="ragman", description="Enter Ragman's trader level", type=int, choices=[0, 1, 2, 3, 4])
@option(name="jaeger", description="Enter Jaeger's trader level", type=int, choices=[0, 1, 2, 3, 4])
@option(name="ref", description="Enter Ref's trader level", type=int, choices=[0, 1, 2, 3, 4])
