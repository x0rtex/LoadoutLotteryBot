...
@option(name="therapist", description="Enter Therapist's trader level", choices=[1, 2, 3, 4])
@option(name="skier", description="Enter Skier's trader level", choices=[1, 2, 3, 4])
@option(name="peacekeeper", description="Enter Peacekeeper's trader level", choices=[1, 2, 3, 4])
@option(name="mechanic", description="Enter Mechanic's trader level", choices=[1, 2, 3, 4])
@option(name="ragman", description="Enter Ragman's trader level", choices=[1, 2, 3, 4])
@option(name="jaeger", description="Enter Jaeger's trader level", choices=[0, 1, 2, 3, 4])
