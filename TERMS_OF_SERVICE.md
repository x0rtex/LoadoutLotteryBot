...
This Terms of Service Agreement (the "Agreement") is entered into between x0rtex ("Bot Owner") and the user ("User") of the Loadout Lottery Discord bot (the "Bot").
...
1. **Use of the Bot:** The Bot Owner grants the User a limited, non-exclusive, non-transferable license to access and use the Bot in accordance with this Agreement.
2. **Prohibited Use:** The User may not use the Bot in any way that violates applicable laws, rules, or regulations or infringes upon the rights of any third party. The Bot may not be redistributed, resold, or offered as a paid service without permission.
...
6. **Indemnification:** The User agrees to indemnify and hold harmless the Bot Owner from claims arising from misuse of the Bot.
...
8. **Governing Law:** This Agreement shall be governed by and construed in accordance with the laws of Ireland. Any disputes arising under or in connection with this Agreement shall be subject to the exclusive jurisdiction of the courts of Ireland.
...
10. **Disclaimer:** This Bot is not affiliated with, endorsed by, or sponsored by Discord.
