...
ALL_WEAPONS: tuple = (
    ...
    Item(
        name="Kalashnikov AK-12 5.45x39",
        category=ASSAULT_RIFLE,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/d/df/AK-12_Image.png/revision/latest/scale-to-width-down/320?cb=20231017095127",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        name="Molot Arms VPO-209 .366 TKM",
        category=ASSAULT_CARBINE,
    ...
    Item(
        name="Molot Arms Simonov OP-SKS 7.62x39",
        category=ASSAULT_CARBINE,
    ...
    Item(
        name="TOZ Simonov SKS 7.62x39 (No Dovetail)",
        category=ASSAULT_CARBINE,
    ...
    Item(
        name="HK MP5K 9x19 (Navy 3 Round Burst)",
        category=SMG,
    ...
    Item(
        ...
        trader_info={
            PRAPOR: [Obtain(level=1, quest_locked=False, barter=True),
                     Obtain(level=1, quest_locked=True, barter=False)],
        },
    ),
    Item(
    ...
    Item(
        name="MP-43-1C 12ga double-barrel",
        category=SHOTGUN,
    ...
    Item(
        ...
        category=PISTOL,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/7/7e/ZiD_SP-81_26x75_signal_pistol.png/revision/latest/scale-to-width-down/320?cb=20231025174626",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={
    ...
    Item(
        ...
        category=MACHINE_GUN,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/e/eb/Degtyarev_rpd_lmg.png/revision/latest/scale-to-width-down/320?cb=20240101215849",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={
    ...
    Item(
        ...
        category=ASSAULT_RIFLE,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/5/59/Sig_mcx_image_rot.png/revision/latest/scale-to-width-down/320?cb=20240101220219",
        always_obtainable=False,
        meta=True,
        flea=True,
        trader_info={
    ...
    Item(
        name="RSh-12 12.7x55",
        category=PISTOL,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/c/cb/RSh-12_Image.png/revision/latest/scale-to-width-down/320?cb=20231025014041",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        name="KBP 9A-91 9x39",
        category=ASSAULT_CARBINE,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/6/64/Kbp_9a91_car.png/revision/latest/scale-to-width-down/320?cb=20240101214721",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=ASSAULT_CARBINE,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/d/d2/Kbp_vsk94_ac.png/revision/latest/scale-to-width-down/320?cb=20240101214601",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        name="Cultist knife",
        category=MELEE,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/d/d7/Cultist_Knife_View.png/revision/latest/scale-to-width-down/320?cb=20231017155835",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={}
...
ALL_HELMETS: tuple = (
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/f/f5/Shattered.png/revision/latest/scale-to-width-down/303?cb=20180721211849",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/3/36/Glori_mask_view.png/revision/latest/scale-to-width-down/320?cb=20240103195212",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={}
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/5/50/Death_Shadow_lightweight_armored_mask_Image.png/revision/latest/scale-to-width-down/320?cb=20240103195410",
        always_obtainable=False,
        meta=True,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/0/0b/Atomic_Defense_CQCM_Image.png/revision/latest/scale-to-width-down/320?cb=20231228130717",
        always_obtainable=False,
        meta=True,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/1/15/Tagilla_Mask_Gorilla_View.png/revision/latest/scale-to-width-down/320?cb=20210701033557",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={}
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/8/8d/Tagilla_Mask_Ubey_View.png/revision/latest/scale-to-width-down/320?cb=20210630165926",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={}
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/7/72/NeoSteelimage.png/revision/latest?cb=20231228134820",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={
    ...
    Item(
        ...
        category=HELMET,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/1/15/Tor-2_Image.png/revision/latest/scale-to-width-down/320?cb=20240107134158",
        always_obtainable=False,
        meta=False,
        flea=False,
        trader_info={
...
ALL_BACKPACKS: tuple = (
    ...
    Item(
        ...
        category=BACKPACK,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/7/79/SATL-Foliage-Fullscale.png/revision/latest/scale-to-width-down/308?cb=20240116210917",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=BACKPACK,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/f/fe/Tehinkom_RK-PT-25_Image.png/revision/latest/scale-to-width-down/278?cb=20240123002648",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
    ...
    Item(
        ...
        category=BACKPACK,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/3/3a/DragonEggMkII_3D.png/revision/latest/scale-to-width-down/292?cb=20240123002514",
        always_obtainable=False,
        meta=False,
        flea=True,
        trader_info={
...
ALL_MAPS: tuple = (
    ...
    GameRule(
        name="Ground Zero",
        category=MAP,
        image_url="https://static.wikia.nocookie.net/escapefromtarkov_gamepedia/images/4/4d/Ground_Zero_Banner.png/revision/latest/scale-to-width-down/320?cb=20231228134014",
        meta=True,
    ),
)
